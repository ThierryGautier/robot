...
int main( void )
{
    ...
    //configure capture to reduce CPU usage required to detect face
    dWidth = capture.get(CV_CAP_PROP_FRAME_WIDTH);
    dHeight = capture.get(CV_CAP_PROP_FRAME_HEIGHT);
    capture.set(CV_CAP_PROP_FRAME_WIDTH,dWidth/2);
    capture.set(CV_CAP_PROP_FRAME_HEIGHT,dHeight/2);
