...
const std::string HOT_WORD1 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/avance.pmdl";
const std::string SENSITIVITY1 = "0.4";

const std::string HOT_WORD2 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/démarre.pmdl";
const std::string SENSITIVITY2 = "0.4";

const std::string HOT_WORD3 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/miamou.pmdl";
const std::string SENSITIVITY3 = "0.4";

const std::string HOT_WORD4 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/recule.pmdl";
const std::string SENSITIVITY4 = "0.4";

const std::string HOT_WORD5 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/command stop.pmdl";
const std::string SENSITIVITY5 = "0.4";

const std::string HOT_WORD6 = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/tourne.pmdl";
const std::string SENSITIVITY6 = "0.4";

const std::string resource_filename = "/media/linaro/DATA/Hikey/Hikey/sound_control/ressources/common.res";

//list of hot words
std::string model_filename(HOT_WORD1+","+
                           HOT_WORD2+","+
                           HOT_WORD3+","+
                           HOT_WORD4+","+
                           HOT_WORD5+","+
...
std::string sensitivity_str(SENSITIVITY1+","+
                            SENSITIVITY2+","+
                            SENSITIVITY3+","+
                            SENSITIVITY4+","+
                            SENSITIVITY5+","+
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Sample Rate:" << detector.SampleRate() << std::endl;
  std::cout << "Num Channels:" << detector.NumChannels() << std::endl;
  std::cout << "Bits Per Sample:" << detector.BitsPerSample() << std::endl;
